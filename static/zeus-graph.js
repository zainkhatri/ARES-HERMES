window.KGGraph = function (el, opts) {
  ...
  function fitView() {
    ...
    // fit-all (no clipping) — the graph fills a compact card because the card is now smaller
    var z = Math.min(W*0.96/Math.max(1,maxx-minx), H*0.94/Math.max(1,maxy-miny));
